...
TEST(ListCmdTest, PushPopTest)
{
    redis_server svr;
    auto cli = [&context = svr.context_]() -> bg_task<>
    {
        EXPECT_EQ(co_await check_input_output(context, "llen a\r\n", ":0\r\n"), true);
        EXPECT_EQ(co_await check_input_output(context, "lpush a 1\r\n", "+OK\r\n"), true);
        EXPECT_EQ(co_await check_input_output(context, "lpush a 2\r\n", "+OK\r\n"), true);
        EXPECT_EQ(co_await check_input_output(context, "exists a\r\n", ":1\r\n"), true);
        EXPECT_EQ(co_await check_input_output(context, "llen a\r\n", ":2\r\n"), true);
        EXPECT_EQ(co_await check_input_output(context, "lpop a\r\n", "$1\r\n2\r\n"), true);
        EXPECT_EQ(co_await check_input_output(context, "llen a\r\n", ":1\r\n"), true);
        EXPECT_EQ(co_await check_input_output(context, "lpop a\r\n", "$1\r\n1\r\n"), true);
        EXPECT_EQ(co_await check_input_output(context, "llen a\r\n", ":0\r\n"), true);
        co_return;
