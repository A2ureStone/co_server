...
TEST(StringCmdTest, SetGetTest)
{
    redis_server svr;
    auto cli = [&context = svr.context_]() -> bg_task<>
    {
        EXPECT_EQ(co_await check_input_output(context, "exists a\r\n", ":0\r\n"), true);
        EXPECT_EQ(co_await check_input_output(context, "set a 1\r\n", "+OK\r\n"), true);
        EXPECT_EQ(co_await check_input_output(context, "exists a\r\n", ":1\r\n"), true);
        EXPECT_EQ(co_await check_input_output(context, "get a\r\n", "$1\r\n1\r\n"), true);
        EXPECT_EQ(co_await check_input_output(context, "setnx a 10\r\n", ":0\r\n"), true);
        EXPECT_EQ(co_await check_input_output(context, "del a\r\n", ":1\r\n"), true);
        EXPECT_EQ(co_await check_input_output(context, "get a\r\n", "$-1\r\n"), true);
        EXPECT_EQ(co_await check_input_output(context, "del a\r\n", ":0\r\n"), true);
        EXPECT_EQ(co_await check_input_output(context, "setnx a 10\r\n", ":1\r\n"), true);
        EXPECT_EQ(co_await check_input_output(context, "get a\r\n", "$2\r\n10\r\n"), true);
